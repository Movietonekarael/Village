...
namespace JigglePhysics
{
    ...
    public class JiggleRigBuilder : MonoBehaviour
    {
        ...
        public void FixedSimulateAllBones()
        {
            foreach (JiggleRig rig in jiggleRigs)
            {
                foreach (JiggleBone simulatedPoint in rig.simulatedPoints)
