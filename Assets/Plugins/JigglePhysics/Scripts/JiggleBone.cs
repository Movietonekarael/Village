        ...
        public void CacheAnimationPosition()
        {
            ...
            if (transform == null)
            {
                ...
                if (parent.parent != null)
                {
                    ...
                    Vector3 pos = parent.parent.transform.worldToLocalMatrix * parentTransformPosition;
                    pos = parent.transform.localToWorldMatrix * pos;
                ...
                else
                {
                    ...
                    Vector3 pos = parent.transform.parent.worldToLocalMatrix * parentTransformPosition;
                    pos = parent.transform.localToWorldMatrix * pos;
                    currentTargetAnimatedBoneFrame = new PositionFrame(pos, Time.timeAsDouble);
                }
                return;
            ...
            if (child != null)
            {
                ...
                if (child.transform == null)
                {
                    ...
                    { // If we have a proper jigglebone parent...
                        childPosition = parent.transform.worldToLocalMatrix * transform.position;
                        childPosition = transform.localToWorldMatrix * childPosition;
                    }
                    else
                    { // Otherwise we guess with the parent transform
                        childPosition = transform.parent.worldToLocalMatrix * transform.position;
                        childPosition = transform.localToWorldMatrix * childPosition;
                    }
                }
                else
