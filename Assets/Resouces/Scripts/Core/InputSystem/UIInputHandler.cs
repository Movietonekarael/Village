...
namespace GameCore.GameControls
{
    partial class InputHandler
    {
        ...
        {
            private Mouse _virtualMouse => _InputHandler.VirtualMouse.VirtualMouse;
            ...
            private Camera _mainCamera => _InputHandler._mainCamera;
            private RectTransform _canvasTransform => _InputHandler._canvasTransform;
            ...
            private void TryClickVirtualMouse()
            {
                ...
                if (isVirtualButtonPressed != _previousMouseState)
                {
                    PerformClick(isVirtualButtonPressed);
                }
            }

            private void MoveVirtualMouse()
            {
                if (_virtualMouse == null || !_virtualMouse.enabled ||Gamepad.current == null)
                    return;
            ...
            private void PerformClick(bool isPressed)
            {
